        ...
        <div class="container mx-auto w-full">
          <div class="w-full flex flex-wrap lg:flex-nowrap  gap-[36px]">
            <div class="w-full lg:w-1/2">
              ...
              <div>
                <h4 class="text-[36px] mb-[20px] mt-[25px] font-bold text-[#232F3E]">
                  {title}
                </h4>

                <div
                  dangerouslySetInnerHTML={longDescription}
                  class="text-[#5F6061] text-[18px] space-y-2 pb-10"
                ></div>
              </div>
            </div>

            <div class="w-full lg:w-1/2 ">
              <p class="text-red-500 flex items-center gap-[9px]">
                <span>
                  <svg
                    width="17"
                    height="20"
              ...
              <h4 class="font-bold leading-[42px] text-[36px] mb-2 text-[#232F3E]">
                Headline with a product name and product’s key benefit
              </h4>

              <div class="flex gap-2 items-center mb-[14px]">
              ...
              <section class="bg-[#F0F2F5]  w-full rounded-[10px] p-[22px]">
                <div class="mb-[17px]">
                  ...
                  <ul class="inline-flex border divide-x">
                    ...
                    <li class="w-[104px] h-[56px] lg:w-[151px] lg:h-[56px]  bg-white shadow-sm border border-[#DDD] cursor-pointer  flex items-center flex-col justify-center relative text-[#5F6061] text-center test-sm">
                      <div>1x</div>
                      <div>$79,99/piece</div>
                    </li>
                    <li class="w-[104px] h-[56px] lg:w-[151px] lg:h-[56px]  bg-white shadow-sm border border-[#DDD] cursor-pointer  flex items-center flex-col justify-center relative text-[#5F6061] text-center test-sm">
                ...
                <div class="flex items-center gap-2 mb-[15px]">
                  ...
                  <p class="text-[#5F6061] text-sm">
                    <span class="text-[#3DBD00] text-sm font-bold">
                      In stock.
                    </span>
                    Order in the next{" "}
                    <span class="text-black text-[14px] font-bold ">
                      5h 43m 33s
                    </span>{" "}
                ...
                {/* MESSAGE SUCCESS */}
                <div
                  class="bg-[#090] w-full py-2 h-[62px] px-4 flex rounded-[5px] justify-center items-center gap-4 text-white"
                ...
                <div class="w-full rounded-[7px] mt-5  border-2 border-[#F09831] pb-1.5 bg-white divide-y">
                ...
                <div class="bg-[#E8D7AF] lg:h-[100px] border border-[#E8D7AF] flex w-full  mt-4 px-16 justify-center items-center gap-[10px] ">
                  <img src="/Bitmap.png" alt="" width="63" height={"63"} />
                  <div>
                    <h4 class="text-[#232F3E] text-base font-bold">
                      14-day money-back guarantee
                    </h4>

                    <p class="text-[#5B6064] text-[13px]">
                ...
                <div class="flex gap-2 items-center py-[10px] mb-[46px]">
                  <div class=" w-[92px] h-[22px] -mt-2">
                    <TrustPilot class="object-fit align-middle" />
                  </div>

                  <div class="text-[#181818] text-sm font-bold">Your Shop</div>
                  <div class=" w-[100px]  ">
                    <Image class="object-fit align-middle" />
                  </div>

                  <p class="text-[#181818] text-sm font-bold">4.9 out of 5</p>
                </div>
              </section>
            </div>
          </div>
