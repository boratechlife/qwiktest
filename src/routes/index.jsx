...
box-shadow: 0px 2px 3px 0px rgba(0, 0, 0, 0.10);"
                    ...
                    <div
                      class="select flex px-[12px] justify-between w-[134px] h-[42px] group items-center rounded-[5px] relative border border-[#ddd] group "
                      style="background: linear-gradient(180deg, #FFF 0%, #FAFAFA 100%);
box-shadow: 0px 2px 3px 0px rgba(0, 0, 0, 0.10);"
                    >
                      <ul className="absolute hidden group-hover:block w-full left-0 top-full bg-white  text-[14px] z-50  shadow">
