...
import { ArrowLeft, ArrowRight, BuyMoreIcon, CarDeliveryIcon } from "../icons/qwik";
    ...
    <header class="w-full ">
      <nav class="h-[50px] bg-[#F0F2F5]  py-2 divide-x">
        <div class="container mx-auto">
          <div class="w-full flex flex-wrap lg:flex-nowrap justify-center lg:justify-between items-center relative px-4">
...
<ArrowLeft />
            ...
            <div class="w-full lg:w-1/3 flex justify-center lg:justify-normal items-center gap-1 lg:gap-2">
              <span>
<CarDeliveryIcon />
              </span>
            ...
            <div class="w-full lg:w-1/3 hidden lg:flex items-center gap-2">
              <span>
<BuyMoreIcon />
              </span>
